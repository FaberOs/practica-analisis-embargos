...
- **`nombres`** ⚠️ - Solo se usa en búsqueda global (no en análisis)
- **`identificacion`** ⚠️ - Solo se usa en búsqueda global (no en análisis)

### 5. Columnas Mencionadas pero Poco Usadas
- **`estado_demandado`** ⚠️ - Mencionada en columnas principales pero uso limitado
- **`tipo_carta`** ⚠️ - Mencionada en columnas principales pero uso limitado
